...
Each of you will be made members of the [`coredatascience-fa23` 
organization on GitHub](https://github.com/coredatascience-fa23). 
...
You will notice when you visit the `coredatascience-fa23` 
...
1. Go to: https://github.com/coredatascience-fa23

2. Click on the repository you want to work on. For 
example `<your_GitHub_username>-2023HW1` for Homework 1. 
