...
Each of you will be made members of the [`coredatascience` 
organization on GitHub](https://github.com/coredatascience). 
...
You will notice when you visit the `coredatascience` 
[Github page](https://github.com/coredatascience) that you can 
...
1. Go to: https://github.com/coredatascience

2. Click on the repository you want to work on. For 
example `<your_GitHub_username>-2022HW1` for Homework 1. 
